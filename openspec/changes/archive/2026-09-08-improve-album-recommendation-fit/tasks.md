...
- [x] 5.1 Reconcile `docs/specs/09_recommendation_discovery.md` and the active `migrate-docs-specs` recommendation-discovery delta with the refined displayed-batch diversity and comparison-aware behavior.
